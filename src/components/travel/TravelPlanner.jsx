...
const translations = {
  ar: {
    ...
    placeholder: 'أخبرني عن رحلتك المثالية في الأحساء...',
    send: 'إرسال',
    ...
    tripTitlePlaceholder: 'مثال: رحلة الأحساء',
    save: 'حفظ',
    cancel: 'إلغاء',
    newConversation: 'محادثة جديدة',
    error: 'حدث خطأ. يرجى المحاولة مرة أخرى.',
    greeting: 'مرحباً! أنا مساعد هاسيو للسفر. كيف يمكنني مساعدتك اليوم؟ أخبرني عن وجهتك المفضلة في الأحساء وسأساعدك في التخطيط.',
    day: 'يوم',
    sar: 'ر.س',
  },
  en: {
    title: 'AI Travel Planner',
    placeholder: 'Tell me about your ideal trip in Al-Ahsa...',
    send: 'Send',
    sending: 'Sending...',
    ...
    tripTitlePlaceholder: 'e.g. Al-Ahsa Weekend',
    save: 'Save',
    cancel: 'Cancel',
    newConversation: 'New Conversation',
    error: 'An error occurred. Please try again.',
    greeting: "Hello! I'm Hasio's travel assistant. How can I help you today? Tell me about your preferred destination in Al-Ahsa and I'll help you plan.",
    day: 'Day',
    sar: 'SAR',
  }
}
