...
// Lazy for the same reason, plus one of its own: the section's background video
// must never be part of the landing page's initial cost. The component attaches
...
export default function App() {
  ...
  return (
    ...
    <main className={`home-redesign ${isRtl ? 'rtl' : ''}`} dir={isRtl ? 'rtl' : 'ltr'}>
      ...
      {/* Sits between the quote and the download so the two dark bands (Absher and
          this one) are separated by paper, and so the last thing a visitor reads
          before the store badges is where the product is going. */}
      <Suspense fallback={null}>
        <ImmersiveSection lang={lang} contactUrl={WHATSAPP_URL} />
      </Suspense>
      ...
      <footer className="home-footer">
        ...
        <div className="foot-bottom">
          ...
          <span>26°26′N&nbsp;&nbsp;50°06′E&nbsp;&nbsp;·&nbsp;&nbsp;SAUDI ARABIA</span>
        </div>
      </footer>
