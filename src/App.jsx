...
// ElevenLabs SDK itself is a second, deeper split — it only loads on first press.
const VoiceSection = lazy(() => import('./components/voice/VoiceSection'))
...
const content = {
  en: { nav:['The edit','Places','The app','Concierge','Absher'],getApp:'Get the app',switch:'العربية',eyebrow:'THE EASTERN PROVINCE, CURATED',titleA:'The Eastern Province,',titleB:'beyond the expected.',intro:'A considered guide to Saudi Arabia’s Eastern Province—from the palm shade of the Al-Ahsa oasis to the Gulf shore of Dammam, Khobar and Qatif. Rare stays, storied places and local encounters, selected with care. Now in your pocket.',onIos:'Download on the',appStore:'App Store',onAndroid:'Get it on',playStore:'Google Play',storyKicker:'THE HASIO EDIT',storyTitle:['Travel slowly.','Remember deeply.'],storyBody:'We look beyond the obvious to bring you closer to the people, flavours and landscapes that give the Eastern Province its soul—the world’s largest oasis, the old harbours of the coast, and everything in between.',why:'Why travel with us',values:[['Locally considered','Recommendations shaped by people who know the province by heart.'],['Quietly exceptional','Distinctive stays and experiences, chosen for character—not crowds.'],['Effortlessly yours','Save, plan and book your entire escape from one beautifully simple place.']],placesKicker:'EXPLORE THE EAST',placesTitle:['Timeless places','waiting for you.'],placesBody:'From the heritage quarters of Al-Ahsa to the Gulf shore — experience the Eastern Province like never before.',placesCta:'Explore in the app',places:[['Heritage','Step into history that still lives.'],['Nature','Palms, springs and the Gulf shore.'],['Culture','Traditions that tell our story.'],['Flavours','A table set by the oasis and the sea.'],['Mountains','Caves carved by wind and time.'],['Stays','Desert and seaside retreats worth the journey.']],showKicker:'INSIDE THE APP',showTitle:'Everything the East holds',shots:[['Discover','Heritage sites, oasis paths, corniches and the places locals actually go.'],['Plan','Tell Hasio your pace and your dates. Get an itinerary built around them.'],['Stay & taste','Hotels, farm stays and the tables worth crossing town for.']],plannerName:'Hasio Concierge',plannerStatus:'Online',plannerQuote:'“A quiet three-day escape with heritage, palms and memorable local food.”',plannerRoutes:[['Old Hofuf','Souq, architecture & slow lunch'],['Al Qarah','Caves & an open-air supper'],['Half Moon Bay','Dunes meeting the Gulf at golden hour']],serviceKicker:'YOUR PERSONAL CONCIERGE',serviceTitle:['One journey.','Entirely your own.'],serviceBody:'Tell Hasio what moves you. The planner turns your pace, tastes and travel dates into a considered Eastern Province itinerary—in Arabic or English.',quote:'“The beauty of the East is not only what you see. It is how time feels while you are here.”',dlKicker:'AVAILABLE NOW',dlTitle:'Carry the East with you.',dlBody:'Free on iPhone and Android, in Arabic and English throughout.',footTag:'Curating the soul of the Eastern Province.',privacy:'Privacy',terms:'Terms',support:'Support' },
  ar: { nav:['اختيارات Hasio','الأماكن','التطبيق','مرشدك','أبشر'],getApp:'حمّل التطبيق',switch:'English',eyebrow:'المنطقة الشرقية، كما لم ترها من قبل',titleA:'المنطقة الشرقية،',titleB:'أبعد من المتوقّع.',intro:'دليلك المختار بعناية إلى المنطقة الشرقية—من ظلال نخيل واحة الأحساء إلى سواحل الدمام والخبر والقطيف. إقامات نادرة، أماكن تحكي التاريخ، وتجارب محلية أصيلة. الآن بين يديك.',onIos:'حمّله من',appStore:'App Store',onAndroid:'متوفر على',playStore:'Google Play',storyKicker:'اختيارات Hasio',storyTitle:['تمهّل في رحلتك.','واصنع ذكرى أعمق.'],storyBody:'نأخذك إلى ما وراء المألوف، لتقترب من الناس والنكهات والطبيعة التي تمنح المنطقة الشرقية روحها—من أكبر واحة في العالم إلى موانئ الساحل القديمة.',why:'لماذا تسافر معنا',values:[['برؤية محلية','توصيات يصنعها من يعرف المنطقة عن قرب.'],['استثنائي بهدوء','إقامات وتجارب لها طابعها الخاص، بعيداً عن الزحام.'],['رحلتك ببساطة','احفظ وخطط واحجز رحلتك كاملة من مكان واحد جميل وسهل.']],placesKicker:'استكشف الشرقية',placesTitle:['أماكن خالدة','بانتظارك.'],placesBody:'من أحياء الأحساء التراثية إلى ساحل الخليج، عِش المنطقة الشرقية كما لم تعشها من قبل.',placesCta:'استكشفها في التطبيق',places:[['التراث','ادخل إلى تاريخ ما زال حياً.'],['الطبيعة','نخيل وعيون وساحل خليجي.'],['الثقافة','عادات تروي حكايتنا.'],['النكهات','مائدة تصنعها الواحة والبحر.'],['الجبال','كهوف نحتتها الريح والزمن.'],['الإقامة','منتجعات في الصحراء وعلى الساحل تستحق الرحلة.']],showKicker:'داخل التطبيق',showTitle:'كل ما تحتضنه الشرقية',shots:[['اكتشف','مواقع تراثية ودروب الواحة وكورنيشات والأماكن التي يقصدها الأهالي فعلاً.'],['خطط','أخبر Hasio بإيقاعك وتواريخك، واحصل على برنامج مصمم لك.'],['أقم وتذوّق','فنادق ومزارع للإقامة وموائد تستحق عناء الطريق.']],plannerName:'مرشد Hasio',plannerStatus:'متصل',plannerQuote:'«ثلاثة أيام هادئة بين التراث والنخيل ومائدة محلية لا تُنسى.»',plannerRoutes:[['الهفوف القديمة','السوق والعمارة وغداء على مهل'],['جبل القارة','كهوف وعشاء في الهواء الطلق'],['نصف القمر','كثبان تلامس الخليج عند الغروب']],serviceKicker:'مرشدك الشخصي',serviceTitle:['رحلة واحدة.','مصممة لك.'],serviceBody:'أخبر Hasio بما تحب. يحوّل المخطط وقتك وذوقك وتواريخ سفرك إلى برنامج مدروس للمنطقة الشرقية—بالعربية أو الإنجليزية.',quote:'«جمال الشرقية ليس فقط فيما تراه، بل في إحساس الوقت وأنت هنا.»',dlKicker:'متوفر الآن',dlTitle:'خذ الشرقية معك.',dlBody:'مجاناً على أجهزة iPhone وأجهزة Android، بالعربية والإنجليزية بالكامل.',footTag:'نحتفي بروح المنطقة الشرقية.',privacy:'الخصوصية',terms:'الشروط',support:'الدعم' },
}
...
const SECTIONS = ['story', 'places', 'app', 'concierge', 'voice']
