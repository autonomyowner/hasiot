export const translations = {
  en: {
    ...
    exploreAlAhsa: "Explore Al-Ahsa",
    handpicked: "Handpicked for you",
    findYourStay: "Find your stay",
    stayBannerSub: "Hotels and resorts across the oasis",
    seeAll: "See all",
    ...
    yourPlan: "Your Al-Ahsa plan",
    itinerary: "Itinerary",
    travelTips: "Travel tips",
    estimatedBudget: "Estimated budget",
    suggestHeritage: "A heritage day in Hofuf",
    suggestFamily: "A family weekend",
  ...
  ar: {
    ...
    exploreAlAhsa: "استكشف الأحساء",
    handpicked: "مختارة لك",
    findYourStay: "اعثر على إقامتك",
    stayBannerSub: "فنادق ومنتجعات في أنحاء الواحة",
    seeAll: "عرض الكل",
    ...
    yourPlan: "خطتك في الأحساء",
    itinerary: "برنامج الرحلة",
    travelTips: "نصائح السفر",
    estimatedBudget: "الميزانية التقديرية",
    suggestHeritage: "يوم تراثي في الهفوف",
    suggestFamily: "عطلة نهاية أسبوع عائلية",
