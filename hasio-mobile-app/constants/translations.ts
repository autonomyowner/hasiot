export const translations = {
  en: {
    // Onboarding
    welcome: "Welcome to the Eastern Province",
    welcomeSubtitle: "Thirteen cities, one journey",
    heroGreeting: "Ahlan wa Sahlan fi Al-Sharqiya",
    heroSubtext: "From the world's largest natural oasis to the Gulf shore",
    ...
    // Home
    searchPlaceholder: "Search places in the Eastern Province...",
    discoverLodging: "Discover Eastern Province Hospitality",
    ...
    tours: "Tours",
    whereTo: "Where to?",
    searchHint: "Stays, places, tours, events",
    exploreProvince: "Explore the East",
    handpicked: "Handpicked for you",
    findYourStay: "Find your stay",
    stayBannerSub: "Hotels and resorts across the province",
    seeAll: "See all",
    ...
    filterType: "Type",
    filterPlace: "Place",
    errorAlreadyReviewed: "You have already rated this place. Edit your review instead.",
    errorNotYourReview: "You can only change your own review.",
    errorReviewGone: "That review is no longer there.",
    errorReviewTooLong: "That review is too long. Shorten it and try again.",
    edit: "Edit",
    editListing: "Edit listing",
    saveChanges: "Save changes",
    listingUpdated: "Your changes were sent for review.",
    editReviewNotice: "Saving sends this back for review before it goes live again.",
    filterBudget: "Budget",
    filterBudgetNote: "Nightly rate, for stays only.",
    filterBudgetMin: "From",
    filterBudgetMax: "Up to",
    filterClear: "Clear",
    ...
    plannerGreeting: "I'm here to help you plan the perfect day in the Eastern Province. What would you like to explore today?",
    ...
    sendMessage: "Send",
    plannerSubtitle: "Tell me what you like and I'll shape it into a day-by-day plan.",
    quickSuggestions: "Quick suggestions",
    plannerEyebrow: "AI travel planner",
    plannerTitle: "Plan your days",
    newChat: "New chat",
    newChatConfirm: "Start over? This clears the conversation.",
    yourPlan: "Your Eastern Province plan",
    itinerary: "Itinerary",
    travelTips: "Travel tips",
    estimatedBudget: "Estimated budget",
    suggestHeritage: "A heritage day in Al-Ahsa",
    suggestFamily: "A family weekend by the sea",
    suggestFood: "Where to eat tonight",
    ...
    userTypeUserDesc: "Browse and discover Eastern Province attractions",
    ...
    rateYourStayBody: "Your rating helps other travellers in the Eastern Province.",
  ...
  ar: {
    // Onboarding
    welcome: "أهلاً وسهلاً بك في المنطقة الشرقية",
    welcomeSubtitle: "ثلاث عشرة مدينة، رحلة واحدة",
    heroGreeting: "أهلاً وسهلاً في الشرقية",
    heroSubtext: "من أكبر واحة طبيعية في العالم إلى ساحل الخليج",
    ...
    // Home
    searchPlaceholder: "البحث عن أماكن في المنطقة الشرقية...",
    discoverLodging: "ضيافة الشرقية",
    ...
    tours: "جولات",
    whereTo: "إلى أين؟",
    searchHint: "إقامة، أماكن، جولات، فعاليات",
    exploreProvince: "استكشف الشرقية",
    handpicked: "مختارة لك",
    findYourStay: "اعثر على إقامتك",
    stayBannerSub: "فنادق ومنتجعات في أنحاء الشرقية",
    seeAll: "عرض الكل",
    ...
    filterType: "النوع",
    filterPlace: "المكان",
    errorAlreadyReviewed: "لقد قيّمت هذا المكان من قبل. يمكنك تعديل تقييمك.",
    errorNotYourReview: "لا يمكنك تعديل تقييم شخص آخر.",
    errorReviewGone: "هذا التقييم لم يعد موجوداً.",
    errorReviewTooLong: "التعليق طويل جداً. اختصره وحاول مرة أخرى.",
    edit: "تعديل",
    editListing: "تعديل الإعلان",
    saveChanges: "حفظ التغييرات",
    listingUpdated: "تم إرسال تعديلاتك للمراجعة.",
    editReviewNotice: "الحفظ يعيد الإعلان إلى المراجعة قبل نشره من جديد.",
    filterBudget: "الميزانية",
    filterBudgetNote: "سعر الليلة، للإقامة فقط.",
    filterBudgetMin: "من",
    filterBudgetMax: "إلى",
    filterClear: "مسح",
    ...
    plannerGreeting: "أنا هنا لمساعدتك في التخطيط ليوم مثالي في المنطقة الشرقية. ماذا تريد أن تستكشف اليوم؟",
    suggestLodging: "ابحث عن مكان للإقامة",
    suggestItinerary: "خطط ليوم كامل",
    chatPlaceholder: "اسألني أي شيء عن رحلتك...",
    sendMessage: "إرسال",
    plannerSubtitle: "أخبرني بما تحب، وسأحوّله إلى خطة يوماً بيوم.",
    quickSuggestions: "اقتراحات سريعة",
    plannerEyebrow: "مخطط الرحلات الذكي",
    plannerTitle: "خطط أيامك",
    newChat: "محادثة جديدة",
    newChatConfirm: "البدء من جديد؟ سيتم مسح المحادثة.",
    yourPlan: "خطتك في الشرقية",
    itinerary: "برنامج الرحلة",
    travelTips: "نصائح السفر",
    estimatedBudget: "الميزانية التقديرية",
    suggestHeritage: "يوم تراثي في الأحساء",
    suggestFamily: "عطلة عائلية على البحر",
    suggestFood: "أين نأكل الليلة؟",
    ...
    rateYourStayBody: "تقييمك يساعد المسافرين الآخرين في الشرقية.",
